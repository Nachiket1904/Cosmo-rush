#import all necesessary libaries
import sys
import pygame
import random
#import all classes and utils functions
...
pygame.display.set_caption("Cosmo Rush")
clock = pygame.time.Clock()

# A main function to manage the game flow and start the background music.
def main():
...
# creation of the game objects using sprite groups
...
# the game loop for handeling of evenets and game object collision checking manage play and pause functionality in the game.
while running:
    ...
    #just change background here
    if score >= 2000 and not new_background_activated:
        current_image = background_img2
        background_top = background_img2.copy()
        new_background_activated = True

    if score >= 4000 and new_background_activated:
        current_image = background_img3
        background_top = background_img3.copy()

    if score >= 5000 and new_background_activated:
    ...
    if score >= 3000 and not boss1_spawned:
